...
public class PasswordInputView extends EditText {
    ...
    private static final float defaultContMargin = 1f;//5;
    private static final float defaultSplitLineWidth = 0.5f;//3;

   // private int borderColor = 0xFFCCCCCC;
    private int borderColor = Color.WHITE;

    private float borderWidth = 2;//5;
    private float borderRadius = 1;//3;

    private int passwordLength = 6;
  //  private int passwordColor = 0xFFCCCCCC;
    private int passwordColor = Color.GRAY;
    ...
    protected void onDraw(Canvas canvas) {
     ...
     // borderPaint.setColor(Color.WHITE);
        ...
        for (int i = 1; i < passwordLength; i++) {
            ...
            canvas.drawLine(x, 0, x+4, height, borderPaint);
        }
